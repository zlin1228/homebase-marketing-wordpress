...
if ( have_rows('flexible_content') ) :
  ...
  while ( have_rows('flexible_content') ) : the_row();
                            ...
                            <div class="pricing-plan-table">
                              ...
                              <div class="plan-body">
                                <div class="plan-price">
                                  ...
                                  <div class="crossed-out-price"><?php echo $monthly_price; ?></div>
                                  <?php endif; ?>
            ...
            <div class="row footer">
              <div class="col col-12 offset-sm-1 col-sm-10">
                <div class="col-inner">
                  ...
                  <?php endif; ?>
                  <?php if($add_link) : ?>
                    <a class="text-link-arrow hide-for-sm" href="<?php echo $f_link_url; ?>"><?php echo $f_link_text; ?></a>
                  <?php endif; ?>
                  </div>
                </div>
              </div>
    ...
    elseif ( get_row_layout() == 'pricing_detail' ) : ?>
      ...
      <div id="hb-pricing-detail" class="section section-pricing-detailed hide-for-sm">
        <div class="container-narrow">
          <div class="row header">
            <div class="col col-12">
              <div class="col-inner">
