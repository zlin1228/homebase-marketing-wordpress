...
<main id="primary" class="page-row-expanded <?php echo (get_field('fixed_header')) ? 'has-fixed-header' : ''; ?>">
 <?php
		...
		if ( get_row_layout() == 'flex_hero' ) : ?>
			...
			<?php if (!get_sub_field('hide_widget')) :
				...
				if ($hero_style == 'with-picture') : ?>
					...
					$sign_up_action  = (get_sub_field('sign_up_action')) ? get_sub_field('sign_up_action') : 'https://app.joinhomebase.com/onboarding/sign_up';
      ...
      elseif ( get_row_layout() == 'flex_bs_pictured' ) : ?>
		...
		elseif ( get_row_layout() == 'flex_2_column' ) : ?>
			...
			<?php if (!get_sub_field('hide_widget')) : ?>
				...
				$form_link      = (get_sub_field('sign_up_action')) ? get_sub_field('sign_up_action') : 'https://app.joinhomebase.com/onboarding/sign_up';
				?>
										...
										<div class="columns <?php echo $col_class; ?>">
											<div class="col-3-col">
                                                ...
                                                <div class="col-3-col-img" style="text-align: <?php echo $text_alignment; ?>;">
                                                    ...
                                                    <?php } ?>
                                                    <img class="lazyload" alt="USP Icon" src="<?php echo $col_img; ?>">
                                                    <?php if ($learn_more) { ?>
                                                        </a>
                                                    <?php } ?>
							...
							>
								...
								>
									<div class="columns large-6 medium-6 medium-offset-3 large-offset-0">
										...
										// logo
										if ($logo) : ?>
											<img class="lazyload" alt="Proof Quote Logo" src="<?php echo $logo; ?>" class="proof-quote-logo">
										<?php endif; ?>
							...
							<div class="row">
								...
								<div class="columns medium-5 <?php echo (!$st1_image) ? 'medium-offset-6' : '';?> static-text-section-body">
									...
									if ($st1_icon_above_headline) : ?>
										<img class="lazyload static-text-section-icon" alt="Homebase Icon" src="<?php echo $st1_icon_above_headline; ?>" class="static-text-section-icon">
									<?php endif; ?>
									...
									if ($st1_add_link_with_icon) : ?>
										<a class="static-text-section-link-with-icon" href="<?php echo $st1_link_url ?>">
											<img class="lazyload" alt="Homebase Icon" src="<?php echo $st1_link_icon; ?>" alt="">
									...
									if (have_rows('st1_bottom_links')) : ?>
										<ul class="static-text-section-bottom-links">
											<?php while ( have_rows('st1_bottom_links') ) : the_row(); ?>
												...
												<li>
													<a href="<?php the_sub_field('link_url'); ?>" target="_blank" rel="noopener noreferrer">
						...
						<div class="quote-wrapper" style="background-image:url(<?php echo $background; ?>)">
							<div class="columns medium-4 text-center col-2-left-col">
								<div class="photo-group">
									<div class="photo"><img class="lazyload" alt="Author Photo" src="<?php echo $author_photo; ?>"/></div>
											...
											<div class="columns large-4 medium-6">
												<div class="pos-item">
													...
													<div class="pos-img">
														...
														if ($img) : ?>
															<div>
																<img class="lazyload" src="<?php echo $img; ?>" alt="<?php the_title(); ?>">
															</div>
														<?php endif; ?>
													</div>
		...
		elseif ( get_row_layout() == 'flex_illustration' ) : ?>
			...
			<?php if (!get_sub_field('hide_widget')) : ?>
				...
				<div class="illustration-section <?php echo ($reverse_mode) ? 'reverse' : ''; ?>" <?php echo ($scroll_anchor) ? 'data-anchor="#' . $scroll_anchor . '"' : ''; ?>>
					...
					<img class="lazyload" src="<?php echo $image; ?>" class="illustration">
					...
					<div class="row reviews">
									<?php if ( have_rows('reviews') ) :
											while ( have_rows('reviews') ) : the_row();
													...
													echo '          <div class="score"><img class="lazyload" src="' . get_sub_field('score') . '" alt="Score" /></div>';
													echo '          <div class="company"><img class="lazyload"  src="' . get_sub_field('company_logo') . '" alt="Platform" /></div>';
...
<?php if ($sticky_header) : ?> </div><?php endif; ?>
													...
													<!-- <a href="https://app.joinhomebase.com/onboarding/sign_up?utm_source=marketing%20site&utm_campaign=signups&utm_term=pricing_grid&utm_content=<?php //echo $utm_content; ?>" class="button">
														<?php //echo $button_text; ?>
													</a> -->

													<a href="https://app.joinhomebase.com/onboarding/sign_up" class="button">
														<?php echo $button_text; ?>
													</a>
															...
															<?php while ( have_rows('list') ) : the_row(); ?>
																<li<?php echo (get_sub_field('add_divider_below')) ? ' class="divider-below"' : ''; ?>>
																	...
																	if (get_sub_field('add_tooltip')) : ?>
																		<a id="<?php echo $tooltip_id; ?>" href="#" class="qstn-icn"><img class="lazyload" src="/wp-content/uploads/2018/05/icn-questn.svg"></a>
																			...
																			<?php if (!($tooltip_video)) : ?>
																				<div class="row">
																					<div class="columns small-12 medium-12">
																						...
																						<p class="tooltip_description"><?php echo $tooltip_description; ?></p>
																						<a href="<?php echo $tooltip_learn_more_link; ?>" class="tooltip_learnmore"><?php echo $tooltip_learn_more; ?></a>
																						<a href="#" class="tooltip_close"><img class="lazyload" src="/wp-content/uploads/2018/06/icn-close.png"></a>
																					</div>
																				</div>
																			<?php endif; ?>
																		</div>
								...
								<div class="columns icon-list-item">
									...
									if ($icon) : ?>
										<div class="icon-list-item-icon">
											<div>
												<img alt="Feature Icon" class="lazyload" src="<?php echo $icon; ?>">
											</div>
										</div>
									<?php endif; ?>
								...
								<div class="columns medium-3 small-6 zendesk-cat-col text-center">
									<a href="<?php echo $url; ?>" class="zendesk-cat" target="_blank">
										<div class="zendesk-cat-img">
											<img class="lazyload" src="<?php echo $image; ?>" alt="<?php echo $name; ?>">
										</div>
										<h4><?php echo $name; ?></h4>
							...
							if( $posts ): ?>
										<?php foreach($posts as $post) : ?>
											...
											<div class="columns medium-4">
												<div class="pos-item">
													<div class="pos-img">
														<a href="<?php the_permalink(); ?>"><img class="lazyload" src="<?php echo get_the_post_thumbnail_url(); ?>" alt="<?php echo the_title(); ?>"/></a>
													</div>
													<div class="pos-date">
								...
								<div class="columns large-6 medium-6 active" cat-it="<?php echo $cats; ?>">
									<div class="integrations-post">
										<div class="integrations-post-img">
											<div>
												<img class="lazyload" src="<?php echo $final_img; ?>" alt="">
											</div>
										</div>
							...
							<div class="columns large-6 medium-4 getintouch-img">
								<div class="getintouch-img-table">
									<div class="getintouch-img-col">
										<img alt="Get Touch icon" class="lazyload" src="<?php echo $image; ?>">
									</div>
								</div>
							</div>
				...
				<div class="integrations-tabs-section press-list-section" <?php echo ($scroll_anchor) ? 'data-anchor="#' . $scroll_anchor . '"' : ''; ?>>
							...
							<div class="columns">
								<div class="row press-featured-post">
									<div class="columns medium-6 press-featured-img">
										<div>
											<img class="lazyload" alt="Article Company logo" src="<?php echo $logo; ?>">
										</div>
									</div>
							...
							<?php while ($the_query->have_posts()) : $the_query->the_post(); ?>
								...
								<div class="columns large-4 medium-6 active">
									<div class="integrations-post">
										<div class="integrations-post-img">
											<div>
												<img alt="Article Company Logo" class="lazyload" src="<?php echo $logo; ?>">
											</div>
										</div>
										<div class="integrations-post-content">
											<h3><?php echo $title; ?></h3>
					...
					<div class="row press-load-more">
						<div class="columns text-center">
							...
							<img alt="Spinner Loading" class="lazyload" src="<?php echo get_site_url(); ?>/wp-admin/images/spinner.gif"/>
						</div>
					</div>
										...
										<?php while ( have_rows('table') ) : the_row(); ?>
											...
											<tr>
												...
												<td>
													...
													$left_column = ($left_column) ? '/images/feat-comparison-true.png' : '/images/feat-comparison-false.png';
													?>
												...
												<td>
													...
													$right_column = ($right_column) ? '/images/feat-comparison-true.png' : '/images/feat-comparison-false.png';
													?>
					...
					<div class="row">
						<div class="columns medium-5 rate-compare-hb medium-offset-1">
							...
							<p class="rate-compare-title">
								<img class="lazyload" src="<?php echo $left_column_logo; ?>"/>
							</p>
							<img class="lazyload" src="<?php the_sub_field('left_column_rate'); ?>">
						...
						<div class="columns medium-5">
							<p class="rate-compare-title">
								<img class="lazyload" src="<?php echo $right_column_logo; ?>"/>
							</p>
							<img class="lazyload" src="<?php the_sub_field('right_column_rate'); ?>">
							<?php if (have_rows('feature_list')) : ?>
								<ul>
									<?php while ( have_rows('feature_list') ) : the_row(); ?>
