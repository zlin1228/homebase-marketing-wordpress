              ...
              <div class="row">
                <div class="col col-12">
                  <div class="col-inner">
                    ...
                    <div class="divider hide-for-sm"></div>
      ...
      elseif ( get_row_layout() == 'flex_2_cols' ) : ?>
        ...
        ?>
          ...
          <div class="section section-2-cols">
            <div class="container-narrow">
              <div class="row <?php echo ($reverse)? 'reverse' : '';?> v-align-middle">
                ...
                <div class="col col-12 col-sm-9 offset-sm-3">
                  <div class="col-inner">
                    ...
                    <div class="quote-container">
                      <?php if ($quote) : ?>
                          <?php if($add_link) : ?>
                            <a href = "<?php echo $customer_link; ?>" target="_blank" data-wpel-link="external" rel="noopener noreferrer"> 
                          <?php endif; ?>
                      ...
                      <div class="row v-align-middle">
                        <div class="col col-12 col-sm-8 col-left">
                          <div class="col-inner">
                            <?php
                              if ($banner_text) :
                                echo '<h3 class="fw-black">' . $banner_text . '</h3>';
                              endif;
                            ?>
                          </div>
                        </div>
