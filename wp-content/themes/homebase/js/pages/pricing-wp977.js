( function( $ ) {
  ...
  $(".hb-new-toggle-btn .hb-toggle-col").click(function(e){
    ...
    if( !$(this).hasClass("active") ){
      ...
      $('.section-pricing-teable .annually-save-text').toggle();
    }
...
$('#pricing-d-table').on('click', 'tr.expandable', function(){
  ...
  if(!$(this).hasClass('active')) {
    $('tr.expandable.active').each(function() {
      ...
      $(this).next('tr.hidden-tr').find(".expandable-content-wrap-pricing, .expandable-check-wrap div").slideUp(400);
    });
  }

  $(this).toggleClass('active');
  $(this).next('tr.hidden-tr').find(".expandable-content-wrap-pricing, .expandable-check-wrap div").slideToggle(400);
});
