...
<br><br>
      <a href="https://app.joinhomebase.com/onboarding/sign-up?referral_code=D567-A4EC" id="start-now" target="_blank" class="primary-cta"><?php the_field('button_text'); ?></a>  </div>
  </div>
</section>
