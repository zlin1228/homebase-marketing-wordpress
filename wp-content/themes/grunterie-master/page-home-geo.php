      ...
      <p><?php the_field('h2_headline'); ?></p>
        <!--Custom form Start -->
          <div class="small-12 medium-6 medium-centered columns">
           <form action="https://app.joinhomebase.com/onboarding/sign-up?email=$_GET['email']" id="home-signup-form" method="GET" class="home-form">
              <!-- <fieldset>
