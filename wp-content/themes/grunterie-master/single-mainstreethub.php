<?php
/*
Template Name: Home - Main Street Hub
*/
get_header(); ?>
...
<br><br>
      <a href="https://app.joinhomebase.com/onboarding/sign-up?referral_code=CB78-3177" id="start-now" target="_blank" class="primary-cta"><?php the_field('button_text'); ?></a>  </div>
  </div>
</section>
