<?php
/*
Template Name: Home - Hero - Flexible
*/
get_header(); ?>
    ...
    $section_index = "section-".$index;
            ...
            if ( get_row_layout() == '2_column_intro' ) : ?>
              ...
              <?php if (!get_sub_field('hide_widget')) : ?>
                ...
                $bg_desk            = get_sub_field('background_image_desk');
                $bg_mobile          = get_sub_field('background_image_mobile');
                $bg_pos             = get_sub_field('background_align');
                ...
                <?php
                  ...
                  if ($background) :
                    echo '.column-intro {';
                      ...
                      if($bg_desk)
                        echo 'background-image: url('. $bg_desk .');';
                      if($bg_pos)
                        echo 'background-position:'. $bg_pos .' right;';
                    echo 'background-repeat: no-repeat;';
                    echo 'background-size: cover;';
                    echo '}';
                    if ($bg_mobile) :
                      echo '@media screen and (max-width: 640px) {.column-intro { background-image: url('. $bg_mobile .');';
                      if($height) :
                  ...
                  if ($borders) :
                    echo '.section.'.$section_index.':after{ max-width:'.$border_length.'%; border-bottom:'.$border_width.'px solid '.$border_color.'; left: calc(50% - '.($border_length/2).'%);}';
                  endif;
                  echo '</style>';
                ?>
                  <div class="row">
            ...
            elseif ( get_row_layout() == 'testimonials' ) : ?>
              ...
              <?php if (!get_sub_field('hide_widget')) : ?>
                ...
                <?php
                  ...
                  $background         = get_sub_field('background');
                  $headline             = get_sub_field('headline');
                  $bottomline          = get_sub_field('bottomline');
                ?>
