                ...
                <div class="row">
                    <div class="columns large-6 text-left col-2-right-col col-form">
                        ...
                        <?php if ( get_sub_field( 'sign_up_google' ) ){?>
                            <a href="<?php echo get_sub_field('google_link'); ?>" class="google-lnk"><img src="<?php bloginfo('template_url'); ?>/img/google-icon.png"  width="18" />Sign up with Google</a>
                            <div class="or">OR</div>
                        <?php } ?>
                        ...
                        <div class="col-2-section">
                            ...
                            <div class="row">
                                <div class="columns large-6 text-left col-2-right-col col-content">
                                    <img class="lazyload hide-desktop" data-src="<?php echo get_sub_field('image'); ?>" />
                                ...
                                <div class="columns large-6 col-2-left-col col-image">
                                    <img class="lazyload hide-mobile" data-src="<?php echo get_sub_field('image'); ?>" />
                                </div>
                            </div>
                        </div>
                    </div>
