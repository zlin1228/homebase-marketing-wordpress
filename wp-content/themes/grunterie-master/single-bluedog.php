...
<img src="https://joinhomebase.com/wp-content/uploads/2017/06/bluedog-logo-1.png" />
      <h1><?php the_field('h1_headline'); ?></h1>
      <p><?php the_field('h2_headline'); ?></p>
 
<br><br>
      <a href="https://app.joinhomebase.com/onboarding/sign-up?referral_code=3345-494B" id="start-now" target="_blank" class="primary-cta"><?php the_field('button_text'); ?></a>  </div>
  </div>
</section>
