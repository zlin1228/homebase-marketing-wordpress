...
<section class="banner tall" style="background-image: url(<?php the_field('background_image'); ?>);"> 
  ...
  <div class="test row overlay-content">
    <div class="small-12 medium-10 medium-centered columns">
      ...
      <!-- <a href="https://app.joinhomebase.com/onboarding/sign-up" id="start-now" target="_blank" class="primary-cta"><?php the_field('button_text'); ?></a> -->
    </div>
  </div>
</section>
...
<?php /* Start loop */ ?>
  <?php while (have_posts()) : the_post(); ?>
    ...
    <!-- <div class="testiomial-slider ptl pbl">
      <div class="row">
        <div class="small-11 small-centered medium-9 medium-centered columns">
          <h3 class="text--center text--purple text--medium">Merchants like you love Homebase &#9829;</h3>
    ...
    <div class="customers section border-n">  
      <div class="row">
    ...
    <div class="testimonial border-b">
      <div class="row">
        <div class="small-11 small-centered medium-7 medium-centered columns">
          <?php if( have_rows('testimonial') ): ?>
            <ul class="testimonial-slides">
              <li class="home-testimonial pbm">
                <div class="home-testimonial__quote quote mbs position--relative"><span class="styled-apostrophe">“</span> With 20+ employees on one schedule, Homebase is the best time-saving, headache-reducing business partner I could ask for!”</div>
                <p class="home-testimonial__name text--bold text--grey">BETH P, NORM’S NEWS (KALISPELL, MT)</p>
                <img src="<?php echo get_template_directory_uri(); ?>/img/norms-news.jpg" class="home-testimonial__loc-img" alt="<?php echo $alt; ?>" />
              </li>
            </ul>
          <?php endif; ?>
        </div>
