...
class PostsMethod {
    ...
    public function get_pagination($maxPages){
      $countPosts = $this->count_posts();
      $max_pages = (ceil($countPosts/$this->postsPerPage) > $maxPages) ? $maxPages : ceil($countPosts/$this->postsPerPage);
      ...
      get_template_part( 'templates/custom-blog', 'pagination');
    }
}
