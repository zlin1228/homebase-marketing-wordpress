...
<br><br>
      <a href="https://app.joinhomebase.com/onboarding/sign-up?referral_code=3887-4B4B" id="start-now" target="_blank" class="primary-cta"><?php the_field('button_text'); ?></a>  </div>
  </div>
</section>
