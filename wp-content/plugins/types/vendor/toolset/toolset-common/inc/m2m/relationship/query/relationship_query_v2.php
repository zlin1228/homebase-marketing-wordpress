...
class Toolset_Relationship_Query_V2 {
	 ...
	 * @param IToolset_Relationship_Role|null $in_role If null is provided, the type
	 *    can be in both parent or child role for the condition to be true.
	 *
	 * @return IToolset_Relationship_Query_Condition
	 */
	public function has_domain( $domain_name, IToolset_Relationship_Role $in_role = null ) {
		if( null === $in_role ) {
			return $this->do_or(
		...
		if ( ! $in_role instanceof \IToolset_Relationship_Role_Parent_Child ) {
	 ...
	 * @since 2.5.6
	 */
	public function has_domain_and_type( $type, $domain, IToolset_Relationship_Role $in_role = null ) {
		if( null === $in_role ) {
			return $this->do_or(
