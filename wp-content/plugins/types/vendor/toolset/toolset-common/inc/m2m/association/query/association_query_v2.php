...
class Toolset_Association_Query_V2 extends Toolset_Wpdb_User {
	...
	public function __construct(
		...
		// We do this rather nasty thing in a constructor, knowing that this codebase is becoming obsolete.
		Toolset_Relationship_Database_Operations::get_instance()->ensure_table_existence();
	}
